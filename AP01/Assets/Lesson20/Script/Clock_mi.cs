...
public class Clock_mi : MonoBehaviour
{
    // ------ Public ------
    ...
    private int minuteAnglePropID;         // 材质属性ID
    private int secondAnglePropID;         // 材质属性ID
    ...
    void Update()
    {
        ...
        float minuteAngle = minute  / 60.0f * 360.0f + secondAngle/360.0f * 3.0f;
