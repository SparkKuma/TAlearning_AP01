...
////// Emissive:
                float node_3425 = 0.5;
                float2 node_512 = float2(((dot(i.normalDir,halfDirection)*node_3425)+node_3425),node_3425);
                ...
                float node_3782_if_leA = step(dot(normalize((_HighlightOffset1_var.rgb+i.normalDir)),halfDirection),_HightlightRange1_var);
                float node_3782_if_leB = step(_HightlightRange1_var,dot(normalize((_HighlightOffset1_var.rgb+i.normalDir)),halfDirection));
                float node_9940 = 0.0;
                float node_5885 = 1.0;
                ...
                float node_5393_if_leA = step(dot(normalize((_HighlightOffset2_var.rgb+i.normalDir)),halfDirection),_HightlightRange2_var);
                float node_5393_if_leB = step(_HightlightRange2_var,dot(normalize((_HighlightOffset2_var.rgb+i.normalDir)),halfDirection));
